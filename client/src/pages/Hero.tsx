...
export default function Hero() {
  return (
    <div className="text-textPrimary flex h-full flex-col items-center justify-center rounded-3xl bg-[linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('/photoHero.webp')] bg-cover bg-center text-center">
