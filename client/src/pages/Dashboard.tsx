    ...
    <div className="flex flex-col gap-12">
      <header className="flex items-center justify-between">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-textAccent">Let's keep those good habits going</p>
        </div>
        <button className="bg-textSecondary text-background hover:bg-primary-700 focus:ring-primary-300 flex items-center gap-2 rounded-lg px-8 py-3 font-medium transition-all hover:cursor-pointer focus:ring-4 focus:outline-none">
      ...
      <section className="flex flex-col gap-8">
        <header>
          <h2 className="text-textPrimary text-2xl font-medium">Your Habits</h2>
        </header>
